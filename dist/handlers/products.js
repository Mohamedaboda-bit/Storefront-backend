...
var store = new products_1.products();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.insert(name, price)];
            case 2:
                insert = _a.sent();
                return [2 /*return*/, res.json(insert)];
            case 3:
...
var productHandler = function (app) {
    ...
    app.post('/products/create', tokenValdite_1["default"], create); // need to create user to have access to this route.
};
